 ...
 *
 * @providesModule YiModifiedScrollView
 * @flow
 */
 // Edited by You.i in order to use ListRef instead of RCTScrollView.
'use strict';
...
const ColorPropType = ReactNative.ColorPropType;
...
const ScrollViewStickyHeader = ReactNative.ScrollViewStickyHeader;
...
const ViewStylePropTypes = ReactNative.ViewStylePropTypes;

const createReactClass = require('create-react-class');
const dismissKeyboard = ReactNative.dismissKeyboard;
...
const ScrollView = createReactClass({
  ...
  propTypes: {
    ...
    /**
     * Added by You.i. Specifies the layer name in AE.
     */
...
if (Platform.OS === 'android') {
  ...
  RCTScrollView = requireNativeComponent(
    'ListRef', // You.i change
    (ScrollView: React.ComponentType<any>),
    nativeOnlyProps,
  );
  RCTScrollContentView = requireNativeComponent('ScrollContentData', View);
} else {
  nativeOnlyProps = {
    nativeOnly: {
    }
